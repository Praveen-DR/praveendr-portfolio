        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
              <div>
                ...
                type='text' id="name" name='name' placeholder='Enter you name'
                className='w-full px-4 py-2 rounded-md border  border-gray-300 placeholder:text-white/50 dark:border-gray-700
              ...
              <div>
                ...
                onChange={handleChange}
                type='email' id="email" name="email" placeholder='Enter you email'
              ...
              <div>
                ...
                onChange={handleChange}
                required
                id="message" name="message" placeholder='Enter you message'
                className='w-full px-4 py-2 rounded-md border border-gray-300 placeholder:text-white/50 dark:border-gray-700
                bg-white dark:bg-dark focus:ring-2 focus:ring-primary focus:border-none'/>
              </div>
